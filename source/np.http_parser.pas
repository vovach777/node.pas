...
procedure http_parser_settings_init(var settings : Thttp_parser_settings); cdecl; external HTTP_PARSER_LIB;
function http_parser_execute(const parser:Thttp_Parser; const ps: Thttp_parser_settings; const data: PAnsiChar; len: SIZE_T): size_t; cdecl; external HTTP_PARSER_LIB;
...
procedure http_parser_pause(const parser : Thttp_parser; paused : integer); cdecl; external HTTP_PARSER_LIB;
